...
class MainHandler(BaseHandler):
    def get(self):
        self.response.write('<a href="http://runyunz-final.appspot.com/user1=mojombo&user2=mzgol">Sample</a>')

class CriteriaHandler(BaseHandler):
    def get(self):
    	context = {}
        self.render_response('criteria.html', context)
...
app = webapp2.WSGIApplication([
    (r'/user1=(\w+)&user2=(\w+)', RadarHandler),
    (r'/', MainHandler),
    (r'/criteria', CriteriaHandler)
], debug=True)
